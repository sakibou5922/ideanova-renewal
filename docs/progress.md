...
| 5 | 会社概要の会社名・代表・設立・所在地・TEL・FAX・関連企業が現行と一致し、事業内容が「農業支援事業、化粧水事業」になっている | 合格 | docs/qa-report.md |
...
- 指定文言(変更禁止): 社名「株式会社ideanova」、代表「荒木 裕子」、設立「2019年8月30日」、所在地「〒963-8061 福島県郡山市富久山町福原字陣場176番地2」、TEL「024-905-2746」、FAX「024-905-2107」、関連企業「DDE FINTECH HOLDING」、農業支援事業の本文、WFCストアURL「https://wfca-p.com/」
...
- [ ] 写真受領（docs/images.md の仕様）→ src/data/images.ts 設定 → 再検証
